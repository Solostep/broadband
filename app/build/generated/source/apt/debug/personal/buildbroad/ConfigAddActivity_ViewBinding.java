...
public class ConfigAddActivity_ViewBinding<T extends ConfigAddActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ConfigAddActivity_ViewBinding(final T target, View source) {
    this.target = target;
